    ...
    <div className="w-full h-full bg-slate-100 relative overflow-hidden flex flex-col">
      ...
      <div className="flex-1 relative cursor-crosshair">
        ...
        <div className="absolute top-[25%] left-[35%] group">
           ...
           <div className="absolute top-8 left-1/2 -translate-x-1/2 bg-white border-2 border-black p-3 min-w-[200px] opacity-0 group-hover:opacity-100 transition-all z-20 pointer-events-none shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
        ...
        {/* Map Legend Overlay */}
        <div className="absolute bottom-6 left-6 bg-white border-2 border-black p-4 z-10 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
